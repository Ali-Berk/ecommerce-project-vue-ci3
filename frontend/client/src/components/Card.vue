...
.product-card {
  ...
  overflow: hidden; /* Resimlerin köşelerden taşmasını engeller */
  position: relative;
}
...
/* Görsel Alanı - GÜNCELLENDİ */
.product-img-wrapper {
  height: 260px; /* Sabit yükseklik, kartların eşit boyda olması için önemli */
  overflow: hidden;
  position: relative;
...
.product-img {
  width: 100%;
  height: 100%;
  object-fit: cover; /* Resmi alanı dolduracak şekilde keser */
  /* padding kaldırıldı */
...
/* Stok Olmayan Kart Solukluğu */
.out-of-stock-card {
  opacity: 0.8; /* Biraz daha görünür yaptım */
}
